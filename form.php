              ...
              <!--     <div class="panel-body">
                ...
                <div class="panel-body">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="control-label col-sm-3" for="font1_text">Font(1):</label>
                          <div class="col-sm-9">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                         <label class="control-label col-sm-3" for="font_light">Font:</label>
                          <div class="col-sm-9">
                            <input type="file" class="form-control" id="font_light" name="font_light" required>
                          </div>
                        </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="control-label col-sm-3" for="font2_text">Font(2):</label>
                          <div class="col-sm-9">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="control-label col-sm-3" for="font_bold">Font:</label>
                          <div class="col-sm-9">
                            <input type="file" class="form-control" id="font_bold" name="font_bold" required>
                          </div>
                        </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="control-label col-sm-3" for="font3_text">Font(3):</label>
                          <div class="col-sm-9">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="control-label col-sm-3" for="font_regular">Font:</label>
                          <div class="col-sm-9">
                            <input type="file" class="form-control" id="font_regular" name="font_regular" required>
                          </div>
                        </div>
